      ...
      component = (
        <div>
          ...
          <div className="DateRangeRow">
            <div style={{ margin: "auto", fontSize: "2vw", color: "white" }}>
              Users Added
            </div>
          </div>
          ...
          <div className="AttendanceTableDiv">
            <table className="AttendanceTable">
              ...
              {responses.map((item, index) => {
                ...
                return (
                  <tr
                    className={index % 2 ? "AttendanceRow1" : "AttendanceRow2"}
                  >
                    <td
                      className="AttendanceCell"
                      style={{ width: "65%", fontSize: "1.4vw" }}
                    >
                      {fullNameOfUser}
                      <button
                    ...
                    <td
                      className="AttendanceCell"
                      style={{ width: "25%", fontSize: "1.4vw" }}
                    >
                      {item.userCode}
                    </td>
                    <td
                      className="AttendanceCell"
                      style={{ width: "10%", fontSize: "1.4vw" }}
                    >
                      <button
                        style={{
                          width: "2vw",
                        ...
                        onClick={() => this.giveAlert(item)}
                      >
                        <IconContext.Provider
                          value={{ color: "#ffffff", size: "1vw" }}
                        >
